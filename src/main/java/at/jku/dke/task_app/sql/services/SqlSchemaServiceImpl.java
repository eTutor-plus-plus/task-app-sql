 ...
 */
public class SqlSchemaServiceImpl implements SqlSchemaService {
    private static final Logger LOG = LoggerFactory.getLogger(SqlSchemaServiceImpl.class);

    private final JdbcConnectionParameters parameters;
    private final Connection connection;

    /**
     * Creates a new instance of class {@link SqlSchemaServiceImpl}.
     *
     * @param parameters The JDBC connection parameters.
     * @throws SQLException If the connection could not be established.
     */
    public SqlSchemaServiceImpl(JdbcConnectionParameters parameters) throws SQLException {
