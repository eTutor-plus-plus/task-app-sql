...
//
//    @Autowired
//    private SqlRaTaskGroupRepository repository;
//
...
//        this.taskGroupId = this.repository.save(new SqlRaTaskGroup(1L, TaskStatus.APPROVED, 1, 5)).getId();
//    }
//
//    //#region --- GET ---
//    @Test
...
//            .header(AuthConstants.AUTH_TOKEN_HEADER_NAME, ClientSetupExtension.CRUD_API_KEY)
//            .contentType(ContentType.JSON)
//            .body(new at.jku.dke.etutor.task_app.dto.ModifyTaskGroupDto<>("sql", TaskStatus.APPROVED, new ModifySqlTaskGroupDto(1, 5)))
//            // WHEN
//            .when()
...
//            .header(AuthConstants.AUTH_TOKEN_HEADER_NAME, ClientSetupExtension.CRUD_API_KEY)
//            .contentType(ContentType.JSON)
//            .body(new at.jku.dke.etutor.task_app.dto.ModifyTaskGroupDto<>("", TaskStatus.APPROVED, new ModifySqlTaskGroupDto(1, 5)))
//            // WHEN
//            .when()
//            .post("/api/taskGroup/{id}", this.taskGroupId + 2)
//            // THEN
...
//            .header(AuthConstants.AUTH_TOKEN_HEADER_NAME, ClientSetupExtension.CRUD_API_KEY)
//            .contentType(ContentType.JSON)
//            .body(new at.jku.dke.etutor.task_app.dto.ModifyTaskGroupDto<>("sql", TaskStatus.APPROVED, new ModifySqlTaskGroupDto(1, 10)))
//            // WHEN
//            .when()
...
//    void mapToDto() {
//        // Arrange
//        var taskGroup = new SqlRaTaskGroup(1, 5);
//
//        // Act
